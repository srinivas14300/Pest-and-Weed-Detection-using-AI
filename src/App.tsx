...
function App() {
  ...
  return (
    <div id="theme-container" className="min-h-screen">
      <Router>
        <main>
          <Navbar />
          <PlantAnalysis />
          <Routes>
            <Route path="/" element={
              <div className="bg-gradient-to-b from-green-100 via-white to-emerald-50 flex flex-col items-center text-center px-4">
